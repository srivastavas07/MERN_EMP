...
const dispatch = useDispatch();
  const { employeeSearch } = useSelector(store => store.employee);
  ...
  return (
    <>
      <Header />
      <div className="overflow-x-auto overflow-y-auto max-h-[90vh] text-center mx-auto mt-[10.5%] h-full w-[98%]">
            ...
            {users?.map((user, index) => {
              ...
              return (
                <tr key={user?._id} className='bg-slate-100'>
                  ...
                  <td className="px-4 py-2 border-b border-gray-200">{user.gender}</td>
